...
FeaturedSection.format = function(movies, hSelectMovie) {
  ...
  const cards = movies.map(movie => {
    return `
      <article class="featured-card" style="background-image: url('../server/images/${movie.image}')" onclick="${hSelectMovie}('${movie.id}')">
        <div class="featured-card__overlay">
          <div class="featured-card__body">
            <span class="featured-card__tag">MIS EN AVANT</span>
